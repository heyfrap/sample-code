...
find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*([0-9]+\s*\+\s*[0-9]+)[[:space:]]*\}/it \{ is_expected.to have_attributes(\1: \2) \}/g'

find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*([0-9]+\s*(\+\s*[0-9]+)*)[[:space:]]*\}/it \{ is_expected.to have_attributes(\1: \2) \}/g'

find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*(.*)\}/it \{ is_expected.to have_attributes(\1: \2) \}/g'

find ./spec -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*([^}]*)[[:space:]]*\}/it \{ is_expected.to have_attributes(\1: \2)\}/g'

find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*\s*(.*)\s*\}/it \{ is_expected.to have_attributes(\1: \2)\}/g'

find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*\s*(\S+\s*)\}/it \{ is_expected.to have_attributes(\1: \2)\}/g'

find ./ -name "*.rb" -print | xargs sed -i '' -E 's/its\(\:(.*)\)[[:space:]]*\{[[:space:]]*is_expected.to[[:space:]]*eq[[:space:]]*\s*([^[:space:]]*)\s*\}/it \{ is_expected.to have_attributes(\1: \2)\}/g'
